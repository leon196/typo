...
loadFiles('shader/',['screen.vert','blur.frag','screen.frag','point.vert','quad.vert','color.frag','circle.frag', 'letter.vert', 'letter.frag', 'position.frag', 'velocity.frag'], "text", function(shaders) {
	...
	var amount = ply['eye.ply'].colors.length/3;
	var dimension = Math.pow(2, Math.ceil(Math.log(Math.sqrt(amount)) / Math.log(2)));
	var colors = [];
	var positions = [];
	for (var i = 0; i < dimension*dimension; ++i) {
		if (i < amount) {
			colors.push(ply['eye.ply'].colors[i*3], ply['eye.ply'].colors[i*3+1], ply['eye.ply'].colors[i*3+2]);
			positions.push(ply['eye.ply'].vertices[i*3], ply['eye.ply'].vertices[i*3+1], ply['eye.ply'].vertices[i*3+2]);
		} else {
			colors.push(0,0,0);
			positions.push(0,0,0);
		}
	}
	uniforms.plydimension = dimension;
	uniforms.plycount = amount;
	uniforms.plycolor = twgl.createTexture(gl, {
		mag: gl.NEAREST,
		min: gl.NEAREST,
		format: gl.RGB,
		width: dimension,
		height: dimension,
		src: new Float32Array(colors),
	})
	uniforms.plyposition = twgl.createTexture(gl, {
		mag: gl.NEAREST,
		min: gl.NEAREST,
		format: gl.RGB,
		width: dimension,
		height: dimension,
		src: new Float32Array(positions),
	})
	...
	var column = 6;
	var row = 6;
	var text = "  SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT";
