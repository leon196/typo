...
loadFiles('shader/',['screen.vert','blur.frag','screen.frag','point.vert','quad.vert','color.frag','circle.frag', 'letter.vert', 'letter.frag', 'position.frag', 'velocity.frag'], "text", function(shaders) {
	...
	var column = 6;
	var row = 6;
	var text = "SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT SALUT ";
